...
async def shark(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر سورس رنثون  ⦒
• ( `.م1` )  ⦙ اوامر الخاص 
• ( `.م2` )  ⦙ اوامر الجروبات
• ( `.م3` )  ⦙ اوامر إلـىوتيوب
• ( `.م4` )  ⦙ اوامر الاذاعه 
...
• ( `.م14` ) ⦙ اوامر الميمز 3
• ( `.م15` ) ⦙ اوامر النسب
⎉=====⧼ [𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡](https://t.me/xLxLxLrr3) ⧽=====⎉
""",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
async def shark1(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر الخاص في سورس رنثون  ⦒
⎉ تفعيل ، تعطيل الترحيب 
⎉ قبول ، رفض
⎉ كتم ، الغاء كتم 
⎉ سبام + الكلمه + الرقم (سبام رنثون 22)
⎉ ايدي + ايدي بالرد
⎉ انتحال ● رجوع
⎉=====⧼ [𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡](https://t.me/xLxLxLrr3) ⧽=====⎉
""",
...
async def shark2(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر الجروبات في سورس رنثون  ⦒
⎉ حظر ، الغاء حظر
⎉ مسح المحظورين
⎉ كتم ، الغاء كتم 
⎉ مسح المكتومين
...
async def shark3(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر إلـىوتيوب في سورس رنثون  ⦒
⎉ غ + اسم الاغنيه
⎉ ف + اسم الفيديو
⎉=====⧼ [𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡](https://t.me/xLxLxLrr3) ⧽=====⎉
""",
...
async def shark4(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر الاذاعه في سورس رنثون  ⦒
...
async def shark5(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر الرفع في سورس رنثون  ⦒
...
async def shark6(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة الاوامر الإضافيـة في سورس رنثون  ⦒
...
async def shark7(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر التسليـة في سورس رنثون  ⦒
⎉ `.مكعبات`
⎉ `.قمر`
⎉ `.قلوب`
⎉ `.قلب`
...
async def shark8(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر التسليـة 2 في سورس رنثون  ⦒
⎉ `.غبي`
⎉ `.تفجير`
⎉ `.طوبه`
⎉ `.مربعات`
...
async def shark9(c, msg):
    ...
    animation_chars = [
        """
⎉=====⧼  [𝗦𝗢??𝗥𝗖𝗘 𝗧??𝗣𝗧𝗛𝗢𝗡](https://t.me/xLxLxLrr3) ⧽=====⎉
: ⦑   قائمة اوامر التسليـة 3 في سورس رنثون  ⦒
⎉ `.رموز شيطانيه`
⎉ `.اسعاف`
⎉ `شرطه`
⎉ `.زعلت`
...
⎉ `.عبقري`
⎉ `.قتل`
⎉ انتظرو تحديثات عظمه ل تليثون سورس رنثون 🔥
⎉=====⧼ [𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡](https://t.me/xLxLxLrr3) ⧽=====⎉
""",
    ]
    for i in animation_ttl:
...
async def shark10(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر الالعاب في سورس رنثون  ⦒
 ⎉ `.اكس او` 
...
async def shark11(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر الالعاب المتطوره في سورس رنثون  ⦒
 ⎉ `.القط المجنون` 
⎉ `.ركل الكره`
⎉ `.السمك الشائك`
⎉ `.كرة السله`
...
async def shark12(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر الميمز في سورس رنثون  ⦒
⎉ `.هنضحك`
⎉ `.مينفعش`
...
async def shark13(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر الميمز 2 في سورس رنثون  ⦒
⎉ `.في رمضان`
⎉ `.مش عارف اقوم`
⎉ `.دمك خفيف اوي`
...
async def shark14(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر الميمز 3 في سورس رنثون  ⦒
⎉ `.تاخد نفس عميق`
⎉ `.ربنا نصرني`
⎉ `.لو معايا خنجرين`
⎉ `.اماااال`
...
async def shark15(c, msg):
    ...
    animation_chars = [
        """
[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - أوامـِـࢪ السـورس](https://t.me/xLxLxLrr3)
: ⦑   قائمة اوامر النسب في سورس رنثون  ⦒
⎉ `.نسبة الانوثة`
⎉ `.نسبة الغباء`
⎉ `.نسبة الرجولة`
⎉ `.نسبة المنيكه`
...
async def source(c,msg):
  await msg.edit("⋖⊶◎⊷⌯𝗦𝗢𝗨𝗥𝗖𝗘 ⎉ 𝗥𝗨𝗡𝗧𝗛𝗢𝗡⌯⊶◎⊷⋗\n⎉ ¦ [↱ ˛ َِ𝗔َِ𝗹َِ𝘀َِ𝗵 .¹#  ↲](t.me/BxxBxxL)\n⎉ ¦ [𝙎𝙐𝙋𝙋𝙊𝙍𝙏 𖧊 𝗥𝗨𝗡𝗧𝗛𝗢𝗡](t.me/xLxLxLrr7)\n⎉ ¦ [𝗦𝗢𝗨𝗥𝗖𝗘 𖧊 𝗥𝗨𝗡𝗧𝗛𝗢𝗡](t.me/xLxLxLrr3)\n⋖⊶◎⊷⌯𝗦𝗢𝗨𝗥𝗖𝗘 ⎉ 𝗥𝗨𝗡𝗧𝗛𝗢𝗡⌯⊶◎⊷⋗")
